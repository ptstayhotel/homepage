...
export const offers: Offer[] = [
    ...
    },
    {
        ...
        details: {
            ko: [
                ...
                '아마드티(홍차)를 객실에 무료로 제공해 드립니다.',
                '로비 라운지에서 커피를 무료로 제공해 드립니다 (체크인~체크아웃).',
            ...
            en: [
                ...
                'Complimentary Ahmad Tea provided in your room.',
                'Complimentary coffee at the lobby lounge (from check-in to check-out).',
            ...
            ja: [
                ...
                'アーマッドティー(紅茶)を客室に無料でご用意いたします。',
                'ロビーラウンジでコーヒーを無料でご提供いたします（チェックイン～チェックアウト）。',
    ...
    },
    {
        id: 3,
        type: 'room',
        image: '/images/events/business-package.jpg',
